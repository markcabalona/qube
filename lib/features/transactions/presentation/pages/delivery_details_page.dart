...
class DeliveryDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    )..add(const LoadTransactionsEvent(isInitialLoad: true));
  ...
  _buildSuccessPage(
    ...
    if (transactions.isEmpty) {
      ...
      return TransactionsListBuilder(
        ...
        builder: (context, transaction) => BlocProvider(
          create: (context) => DeliveryDetailsFormCubit(transaction),
          child: DeliveryDetailsFormWidget(
